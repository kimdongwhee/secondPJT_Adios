...
col_1.text(f"(3)Git 주소\n(https://github.com/kimdongwhee/adiosSecondPJT.git)")
col_2.link_button(label="Git 바로가기", url="https://github.com/kimdongwhee/adiosSecondPJT.git", use_container_width=True)
